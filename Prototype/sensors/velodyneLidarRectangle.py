...
class LIDAR(Process):
    def __init__(self, queue=None, port=2368, lasers, cutoff_min_height = -1.,
                 cutoff_max_height = 3., cutoff_min_distance = 0.,
                 cutoff_max_distance = 60.):
        ...
        self.gap_time = True
        self.lasers = lasers
        self.cutoff_min_height = cutoff_min_height
    ...
    def run(self):
        ...
        while True:
            ...
            if cut:
                cloud = np.concatenate(rotation, axis=0)
                laser_cloud = cloud[laser_idx::len(self.lasers)]

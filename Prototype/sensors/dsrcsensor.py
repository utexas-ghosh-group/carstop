...
class DsrcSensor():
    def __init__(self, port):
        self.port = port
        self.me = {'tracker':None, 'time':0, 'count':0, 'starting':True}
        self.other = {'trackers' : [], 'times' : [], 'ids' : [], 'counts' : []}
        
    def __enter__(self):
        self.conn = RxConnector(self.port, 'UDP')
        return self
...
if __name__ == '__main__':
    print("This file doesn't have an example.\nTry CohdaDSRC.py")
